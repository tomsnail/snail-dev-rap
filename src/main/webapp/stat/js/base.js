...
$._templates = {
    confirm: '<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">\
			...
			<div class="modal-content">\
	         ...
	         {{/content}}\
			  <div class="modal-footer">\
	    		<button type="button" class="btn btn-success confirm-btn" {{#hideConfirm}}data-dismiss="modal"{{/hideConfirm}}>{{confirmText}}</button>\
			    <button type="button" class="btn btn-default cancel-btn" data-dismiss="modal">{{cancelText}}</button>\
			  </div>\
			</div>\
		</div>\
	</div>',
...
$.confirm = function (config) {
    config.confirmText = config.confirmText || '确定';
...
$(function () {
    ...
    var html = '<div class="helper-tip">\
		...
		<img src="'+ProjectContext+'/stat/img/yellow.png" width="100"/>\
	</div>';
