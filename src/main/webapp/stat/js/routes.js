(function ($) {
    var URLS = {
        org: {
            home: {
                'projects': ProjectContext+'/org/projects.do',
                'productlines': ProjectContext+'/org/home/productlines.do',
                'groups': ProjectContext+'/org/home/groups.do',
                'grouplist': ProjectContext+'/org/group/groups.do'
            },
            group: {
                'all': ProjectContext+'/org/group/all.do',
                'update': ProjectContext+'/org/group/update.do',
                'delete': ProjectContext+'/org/group/delete.do',
                'create': ProjectContext+'/org/group/create.do'
            },
            productline: {
                'all': ProjectContext+'/org/productline/all.do',
                'update': ProjectContext+'/org/productline/update.do',
                'delete': ProjectContext+'/org/productline/delete.do',
                'create': ProjectContext+'/org/productline/create.do'
            },
            project: {
                'create': ProjectContext+'/project/create.do',
                'delete': ProjectContext+'/project/delete.do',
                'update': ProjectContext+'/project/update.do',
                'search': ProjectContext+'/project/search.do'
            },
            account: {
                'all': ProjectContext+'/account/all.action'
            },
            team: {
                'create': ProjectContext+'/org/team/create.do',
                'changeAccessType': ProjectContext+'/org/team/changeAccessType.do',
                'deleteMember': ProjectContext+'/org/team/deleteMember.do',
                'addMembers': ProjectContext+'/org/team/addMembers.do',
                'update': ProjectContext+'/org/team/update.do'
            }
        },
        workspace: {
            'mine': ProjectContext+'/workspace/myWorkspace.do'
        },
        notify: {
            'unread': ProjectContext+'/account/getUnreadNotificationList.do',
            'clear': ProjectContext+'/account/clearUnreadNotifications.do',
            'all': ProjectContext+'/account/getNotificationList.do',
            'delete': ProjectContext+'/account/readAllNotification.do'
        }
    };
